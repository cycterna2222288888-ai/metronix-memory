...
def test_recall_top_n_defaults():
    ...
    assert s.retrieval_graph_ppr_exclude_dense_anchors is False
...
def test_recall_top_n_from_env(monkeypatch):
    ...
    monkeypatch.setenv("METRONIX_RETRIEVAL_GRAPH_PPR_EXCLUDE_DENSE_ANCHORS", "true")
    s = Settings()
    ...
    assert s.retrieval_graph_ppr_exclude_dense_anchors is True
