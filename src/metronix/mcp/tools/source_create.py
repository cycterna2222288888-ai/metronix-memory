"""MCP tool: metronix_source_create — create a data-source connection."""
...
async def metronix_source_create(
    connector_type: str,
    name: str,
    config: dict[str, Any],
    ...
    try:
        ...
        return {"error": handle_tool_error("metronix_source_create", e).to_dict()}
