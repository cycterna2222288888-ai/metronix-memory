...
class DocumentResponse(BaseModel):
    """Response from metronix_get tool."""
...
class StoreResponse(BaseModel):
    """Response from metronix_store tool."""
...
class StatusResponse(BaseModel):
    """Response from metronix_status tool."""
...
class SyncResponse(BaseModel):
    """Response from metronix_sync tool."""
...
class MemorySearchToolItem(BaseModel):
    """Single hit from metronix_memory_search."""
...
class MemorySearchToolResponse(BaseModel):
    """Response from metronix_memory_search tool."""
...
class MemoryStoreResponse(BaseModel):
    """Response from metronix_memory_store tool."""
...
class MemoryDeleteResponse(BaseModel):
    """Response from metronix_memory_delete tool."""
...
class SearchFastResponse(BaseModel):
    """Response from metronix_search_fast tool."""
...
class MemoryContextResponse(BaseModel):
    """Response from metronix_memory_get_context MCP tool."""
...
class SourceListResponse(BaseModel):
    """Response from metronix_source_list."""
...
class SourceSyncResponse(BaseModel):
    """Response from metronix_source_sync."""
